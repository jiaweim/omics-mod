...
import omics.mod.controller.impl.UnimodDataAccessController;
import omics.mod.model.PTM;
import omics.mod.model.Specificity;
import omics.mod.utils.Utilities;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;
import omics.mod.controller.impl.PRIDEModDataAccessController;
import omics.mod.controller.impl.PSIModDataAccessController;
import omics.mod.exception.DataAccessException;
import omics.mod.model.PSIModPTM;
import omics.mod.utils.PRIDEModUtils;
...
public class ModReader {
    ...
    /**
     * This function allows to remap all possible modifications for a list of modifications, it try to map all
     * modifications from PSI and UniMod into a UniMod list of modifications.
     *
